...
public class MSSPartnersPage_IR extends WebDriverSession {

	public MSSPartnersPage_IR() {
	...
	@FindBy(xpath = "//*[text()='Yes, continue to Pricing']")
	public WebElement PopUpcontinueToPricing;
	...
	@FindBy(xpath = "//*[@id=\"add-ons-cta\"]/div[2]/div[2]/a[1]")
	...
	@FindBy(xpath = "//*[@id='csagSentMethodRadios-email']")
	...
	public boolean offerRadioBtnChck() {
		return offerRadioBtnChck.isSelected();
	...
	public WebElement tnList(String series) {
		// span[text()='MSS AUTOMATION CONSUMER']

		WebDriverWait wait = new WebDriverWait(WebDriverSession.getWebDriverSession(), 10);
		return wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[contains(text(),'" + series
				+ "')]/parent::label/parent::div/parent::div/following-sibling::div")));
	...
	public WebElement offerValidityBar(String offerType) {
		// span[text()='MSS AUTOMATION CONSUMER ACTIVATION SIMONLY FINANCE']

		WebDriverWait wait = new WebDriverWait(WebDriverSession.getWebDriverSession(), 10);
		return wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//label/span[text()='" + offerType
				+ "']/parent::label/parent::div/parent::div/parent::div/parent::div/parent::div/parent::div/parent::div/parent::div/following-sibling::div/div[@class='top-margin']")));
	...
	public WebElement selectNewSeriesNumber(String newseriesnumber) {
		...
		WebDriverWait wait = new WebDriverWait(WebDriverSession.getWebDriverSession(), 10);
		return wait.until(ExpectedConditions.visibilityOfElementLocated(
				By.xpath("//*/text()[normalize-space(.)='" + newseriesnumber + "']/parent::*")));
	...
	public WebElement selectAccountType(String Type) {
		...
		types.put("IR", "//*[@id=\'account_type_container\']/div[2]/div[1]/div");
		types.put("BP", "//*[@id=\"account_type_container\"]/div[2]/div[2]/div");
		types.put("BR", "//*[@id=\"account_type_container\"]/div[2]/div[3]/div");
		types.put("BX", "//*[@id=\"account_type_container\"]/div[2]/div[4]/div");
		types.put("IE", "//*[@id=\"account_type_container\"]/div[2]/div[5]/div");
		types.put("BB", "//*[@id=\"account_type_container\"]/div[2]/div[6]/div");
		types.put("BO", "//*[@id=\"account_type_container\"]/div[2]/div[7]/div");
		WebDriver driver = WebDriverSession.getWebDriverSession();
		return driver.findElement(By.xpath(types.get(Type)));
	}
