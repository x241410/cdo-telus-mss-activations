...
public class MSSPartnersPage_BR extends WebDriverSession {
	...
	@FindBy(xpath = "//*[@id='main-products-product1-cta']/a[contains(text(),'Order Mobile')]")
	public WebElement mobility_button;
	...
	@FindBy(xpath = "//*[@id='offers-content']/div[9]/div[1]/div[2]/span")
	public WebElement MSSAutomationConsumerExpand;

	/*
	 * @FindBy(xpath = "//*[@id='program1014895-expand-icon']/span") public
	 * WebElement MSSAutomationConsumerExpand;
	 */
	...
	@FindBy(xpath = "//*[@id='program1014877-expand-icon']/span")
	...
	@FindBy(xpath = "//*[@id='offers-content']/div[2]/div/span/a[1]")
	public WebElement ExpandAllOffers;
	
	@FindBy(xpath = "//*[@id=\"introductionNewRatePlanManual\"]")
	public WebElement RatePlanCode; 
	
	@FindBy(xpath = "//*[@id=\"selectRatePlanForm\"]/div/div[9]/div[1]/span[contains(text(),'Included Services')]")
	public WebElement IncludedServices ;
	
	@FindBy(xpath = "//*[@id=\"introduction-new-rate-plan-manual-cta\"]/a[contains(text(),'Validate')]")
	public WebElement ValidateCode;

	@FindBy(xpath = "//*[@id=\"wirelessAccountType3\"]")
	public WebElement SelectBussiness_Regular;
	...
	/*public WebElement clickBYODActivationOfferExpandableButton(String programId) {
