...
import com.telus.wnp.steps.MSSPartnersPageSteps_CE;
...
public class MSSPartnersPageTest_TelusCE extends BaseTest {
	...
	static List<String> activationList = new ArrayList<String>();
	/**
	 * @param iTestContext
	 */
	...
	@Test(dataProvider = "test-data", groups = { "MSS_Activation_CE" })
	public void testMethod_MSS(ITestContext iTestContext, String dynamicData) throws Exception {
		
		/*** INPUT DYNAMIC DATA***/
		Reporting.setNewGroupName("ACTIVATION DATA");
		...
		/*** MSS WORKFLOW STEPS ***/
		Reporting.setNewGroupName("MSS TELUS CE ACTIVATION");	
		activationList.add(MSSPartnersPageSteps_CE.performTelusCEActivationFromMSS(fixedDataJson, activationData));
		Reporting.printAndClearLogGroupStatements();
