...
public class MSSPartnersPageTest_KoodoIR extends BaseTest {
	...
	@Test(dataProvider = "test-data", groups = { "MSS_Activation_KOODOIR" })
	public void testMethod_MSS(ITestContext iTestContext, String dynamicData) throws Exception {
		...
		activationList.add(
				MSSPartnersPageSteps_IR.performIRActivationFromMSS(fixedDataJson, "KOODO", activationData, userAccess));
		Reporting.printAndClearLogGroupStatements();
