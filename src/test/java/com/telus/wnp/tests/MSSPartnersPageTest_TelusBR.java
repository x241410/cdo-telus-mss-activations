...
public class MSSPartnersPageTest_TelusBR extends BaseTest {
	...
	@Test(dataProvider = "test-data", groups = { "MSS_Activation_BR" })
	public void testMethod_MSS(ITestContext iTestContext, String dynamicData) throws Exception {
		...
		/*** MSS WORKFLOW STEPS ***/
		Reporting.setNewGroupName("MSS TELUS BR ACTIVATION");	
		activationList.add(MSSPartnersPageSteps_BR.performTelusBRActivationFromMSS(fixedDataJson, activationData, userAccess));
		Reporting.printAndClearLogGroupStatements();
