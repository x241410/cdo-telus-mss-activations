...
public class LoginPageSteps extends BaseSteps {
	 ...
	 * @param appName
	 */
	public static void singInSDApplicationMulti(String appName, JSONObject userAccess) {
	...
	public static void main(String args[]) {
		System.out.println(EncryptionUtils.encode("Dontchange@1234"));
		System.out.println(EncryptionUtils.decode("RG9udGNoYW5nZUAxMjM0"));
	}
	 ...
	 * Method Description: The purpose of this method is to login into Smart Desktop
	 */
	public static void appLogin_KOODO_MSS(JSONObject userAccess) {

		String appName = ReadJSON.getString(appNames, "MSS_KOODO_APP_NAME");

		WebDriverSteps.openApplication(appName);
		BaseSteps.Waits.waitUntilJsAjaxJqueryAngularAngular5RequestsReady();
		LoginPageSteps.singInSDApplicationMulti(appName, userAccess);
		BaseSteps.Waits.waitUntilJsAjaxJqueryAngularAngular5RequestsReadyLongWait();
	 ...
	 * Method Description: The purpose of this method is to login into Smart Desktop
	 */
	public static void appLogin_TELUS_MSS(JSONObject userAccess) {
	...
	public static void appLogin_TelusCorp_MSS(JSONObject userAccess) {
		String appName = ReadJSON.getString(appNames, "MSS_TELUSCORP_APP_NAME");
		WebDriverSteps.openApplication(appName);
		BaseSteps.Waits.waitUntilJsAjaxJqueryAngularAngular5RequestsReady();
		LoginPageSteps.singInSDApplicationMulti(appName, userAccess);
		LoginPageSteps.singInSDApplication(appName);
	...
	public static void appLogin_TelusCorp_MSS() {
		String appName = ReadJSON.getString(appNames, "MSS_TELUSCORP_APP_NAME");
		WebDriverSteps.openApplication(appName);
		BaseSteps.Waits.waitUntilJsAjaxJqueryAngularAngular5RequestsReady();
		LoginPageSteps.singInSDApplication(appName);
